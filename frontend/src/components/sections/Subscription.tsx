      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center max-w-4xl mx-auto">
          ...
          >
            ...
            <Link to="/subscribe?plan=Monthly+Jar" className="w-full bg-brown/10 text-brown font-bold py-4 rounded-full hover:bg-brown hover:text-white transition-colors text-center inline-block">Subscribe Now</Link>
          </motion.div>
          ...
          >
            ...
            <Link to="/subscribe?plan=Spice+Lover+Box" className="w-full bg-mango text-brown font-black py-4 rounded-full hover:bg-[#FFF2C6] transition-colors shadow-[0_0_15px_rgba(255,197,51,0.4)] hover:shadow-[0_0_20px_rgba(255,197,51,0.8)] text-center inline-block">Subscribe Now</Link>
          </motion.div>
        </div>
      </div>
    </section>
