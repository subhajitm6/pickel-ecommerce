            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-xl border border-mango/10">
              ...
              <div className="space-y-4 font-medium text-brown/70">
                <div className="flex justify-between">
                  <span>Subtotal</span>
                  <span className="text-brown font-bold">₹{order.subtotal.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Shipping</span>
                  <span className="text-brown font-bold">{order.shipping === 0 ? 'Free' : `₹${order.shipping.toFixed(2)}`}</span>
                </div>
                <div className="border-t border-mango/20 my-4 pt-4 flex justify-between items-center">
                  <span className="text-xl font-bold text-brown">Total Amount</span>
                  <span className="text-3xl font-black text-pickle">₹{order.total.toFixed(2)}</span>
                </div>
              </div>
            </div>
